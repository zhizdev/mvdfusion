...
from external.sd1.ldm.modules.x_transformer import Encoder, TransformerWrapper  # TODO: can we directly rely on lucidrains code and simply add this as a reuirement? --> test
...
if __name__ == "__main__":
    from external.sd1.ldm.util import count_params
